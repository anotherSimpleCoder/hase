...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> FIRSTNAME = createField(DSL.name("firstName"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>users.lastName</code>.
     */
    public final TableField<UsersRecord, String> LASTNAME = createField(DSL.name("lastName"), SQLDataType.VARCHAR(50).nullable(false), this, "");
